...
namespace ArtDatabanken.Data
{
    ...
    public class RedListCalculation
    {
        ...
        /// </param>
        public RedListCalculation(IUserContext userContext)
        {
            ...
            _factors = CoreData.FactorManager.GetFactors(userContext);
        ...
        public Int32 ContinuingDeclineMax
        {
            get
            {
                ...
                factor = _factors.Get(FactorId.ContinuingDecline);
                factorField = factor.DataType.Field1;
                return factorField.Enum.GetMaxKeyInt();
            }
        }
        ...
        public Int32 ContinuingDeclineMin
        {
            get
            {
                ...
                factor = _factors.Get(FactorId.ContinuingDecline);
                factorField = factor.DataType.Field1;
                return factorField.Enum.GetMinKeyInt();
            }
        }
        ...
        public Int32 ExtremeFluctuationsMax
        {
            get
            {
                ...
                factor = _factors.Get(FactorId.ExtremeFluctuations);
                factorField = factor.DataType.Field1;
                return factorField.Enum.GetMaxKeyInt();
            }
        }
        ...
        public Int32 ProbabilityOfExtinctionMax
        {
            get
            {
                ...
                factor = _factors.Get(FactorId.ProbabilityOfExtinction);
                factorField = factor.DataType.Field1;
                return factorField.Enum.GetMaxKeyInt();
            }
        }
        ...
        public Int32 SeverlyFragmentedMax
        {
            get
            {
                ...
                factor = _factors.Get(FactorId.SeverelyFragmented);
                factorField = factor.DataType.Field1;
                return factorField.Enum.GetMaxKeyInt();
            }
        }
        ...
        public Int32 VeryRestrictedAreaMax
        {
            get
            {
                ...
                factor = _factors.Get(FactorId.VeryRestrictedArea_D2VU);
                factorField = factor.DataType.Field2;
                return factorField.Enum.GetMaxKeyInt();
            }
        }
        ...
        private Boolean IsCriteriaA1Fulfilled(RedListCategory category)
        {
            switch (category)
            {
                case RedListCategory.CR:
        ...
        private Boolean IsCriteriaA2Fulfilled(RedListCategory category)
        {
            switch (category)
            {
                case RedListCategory.CR:
        ...
        private Boolean IsCriteriaA3Fulfilled(RedListCategory category)
        {
            switch (category)
            {
                case RedListCategory.CR:
        ...
        private Boolean IsCriteriaA4Fulfilled(RedListCategory category)
        {
            switch (category)
            {
                case RedListCategory.CR:
        ...
        private Boolean IsCriteriaBAFulfilled(RedListCategory category)
        {
            switch (category)
            {
                case RedListCategory.CR:
        ...
        private Boolean IsCriteriaC1Fulfilled(RedListCategory category)
        {
            if (HasContinuingDecline)
            {
                switch (category)
        ...
        /// </returns>
        private Boolean IsCriteriaC2A2Fulfilled(RedListCategory category)
        {
        ...
        private Boolean IsCriteriaC2BFulfilled(RedListCategory category)
        {
            return (HasExtremeFluctuations &&
