...
{
    /// <summary>
    /// Interface for manager that handles species observation information.
    /// </summary>
    public interface ISpeciesObservationManager
    {
        ...
        /// </summary>
        ISpeciesObservationDataSource DataSource { get; set; }
        ...
        /// </summary>
        /// <param name="userContext">User context.</param>
        /// <param name="speciesActivityCategoryId">Id for requested species activity category.</param>
        /// <returns>Specific activity category with specified id.</returns>
        ISpeciesActivityCategory GetSpeciesActivityCategory(IUserContext userContext, Int32 speciesActivityCategoryId);
