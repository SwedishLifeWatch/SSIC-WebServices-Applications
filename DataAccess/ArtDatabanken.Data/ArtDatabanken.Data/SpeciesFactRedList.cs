...
namespace ArtDatabanken.Data
{
    ...
    public class SpeciesFactRedList : SpeciesFact
    {
        ...
        public SpeciesFactRedList(IUserContext userContext,
                                  ITaxon taxon,
        ...
        public SpeciesFactRedList(IUserContext userContext,
                                  ...
                                  IReference reference,                                    String modifiedBy,
        ...
        /// <summary>
        /// Flag that indicates if automatic calculation already
        /// has been initialized. This flag is used to avoid
        /// redundant initilizations.
        /// </summary>
        ...
        protected ISpeciesFact GetSpeciesFact(SpeciesFactList speciesFacts,
                                              IFactor factor)
        {
            ...
            speciesFactIdentifier = CoreData.SpeciesFactManager.GetSpeciesFactIdentifier(Taxon.Id,
        ...
        protected void GetValues(ISpeciesFact speciesFact,
                                 ref Boolean hasMin,
                                 ref Double valueMin,
        ...
        public virtual void Init(IUserContext userContext, 
                                 SpeciesFactList speciesFacts)
        {
            ...
            if (AllowAutomaticUpdate && !IsInitialized)
            {
                ...
                foreach (IFactor factor in Factor.GetDependentFactors(userContext))
                {
                    speciesFact = GetSpeciesFact(speciesFacts, factor);
                    SetSpeciesFact(speciesFact);
                    speciesFact.UpdateEvent += SetSpeciesFact;
                }
        ...
        /// </summary>
        /// <param name="speciesFact">Species facts with red list information.</param>
        protected virtual void SetSpeciesFact(ISpeciesFact speciesFact)
        {
            ...
            switch (speciesFact.Factor.Id)
            {
                ...
                case ((Int32)FactorId.VeryRestrictedArea_D2VU):
                    ...
                    if (hasProbable)
                    {
                        int32Probable = speciesFact.Field2.EnumValue.KeyInt.Value;
                    }
