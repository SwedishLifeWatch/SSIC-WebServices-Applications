...
namespace ArtDatabanken.Data
{
    ...
    public class RedListCalculator
    {
        ...
        public RedListCalculator(IUserContext userContext, 
                                 ...
                                 String taxonTypeNameDefinite)
        {
            ...
            _calculationBestCase = new RedListCalculation(userContext);
            _calculationProbable = new RedListCalculation(userContext);
            _calculationWorstCase = new RedListCalculation(userContext);
        ...
        public Boolean IsRegionalExtinct
        {
            get
            {
                return ((_swedishOccurrence == SWEDISH_OCCURRENCE_REGIONAL_EXTINCT_OCCASIONALLY_OCCURRING) ||
                        (_swedishOccurrence == SWEDISH_OCCURRENCE_REGIONAL_EXTINCT));
            }
        }
