...
namespace ArtDatabanken.Data.ArtDatabankenService
{
    ...
    public class RedListCriteriaDocumentationCalculator : RedListCalculator
    {
        ...
        public RedListCriteriaDocumentationCalculator(String taxonTypeNameIndefinite,
                                                      String taxonTypeNameDefinite)
            : base(taxonTypeNameIndefinite, taxonTypeNameDefinite)
        {
        ...
        private String GetNumberOfYears(Int64 minNumberOfYears, Int32 numberOfGenerations, Boolean displayNoOfGenerations)
        {
            Int64 numberOfYears;
