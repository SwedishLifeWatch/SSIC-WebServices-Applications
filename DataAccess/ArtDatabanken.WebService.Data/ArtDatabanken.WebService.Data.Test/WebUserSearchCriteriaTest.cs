...
{
    [TestClass]
    public class WebUserSearchCriteriaTest
    {
        private WebUserSearchCriteria _searchCriteria;

        public WebUserSearchCriteriaTest()
        {
        ...
        private WebUserSearchCriteria GetSearchCriteria()
        {
            return GetSearchCriteria(false);
        }

        private WebUserSearchCriteria GetSearchCriteria(Boolean refresh)
        {
            if (_searchCriteria.IsNull() || refresh)
            {
                _searchCriteria = new WebUserSearchCriteria();
            }
