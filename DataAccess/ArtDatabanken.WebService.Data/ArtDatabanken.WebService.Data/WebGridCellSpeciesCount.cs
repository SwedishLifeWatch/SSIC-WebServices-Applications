...
namespace ArtDatabanken.WebService.Data
{
    ...
    /// selceted coordinate system, gridcell size,
    /// centre coodinates (X and Y) for gridcell.
    /// The species counting result i.e. counting number of
    /// species observations and species is based on selected 
    ...
    public class WebGridCellSpeciesCount : WebData
    {
        ...
        /// </summary>
        [DataMember]
        public Int32 SpeciesCount { get; set; }
