...
{
    /// <summary>
    /// Class that manages taxon service requests to Nors.
    /// </summary>
    public class NorsServiceProxy : WebServiceProxyBase
    {
        /// <summary>
        /// The _nors service endpoint address.
        /// </summary>
        private EndpointAddress _norsServiceEndpointAddress;

        /// <summary>
        /// Create a NorsServiceProxy instance.
        /// </summary>
        public NorsServiceProxy()
        {
            WebServiceAddress = null;
            WebServiceProtocol = WebServiceProtocol.SOAP11;
            InternetProtocol = InternetProtocol.Http;
            _norsServiceEndpointAddress = null;
        }
        ...
        public override EndpointAddress GetEndpointAddress()
        {
            ...
            if (_norsServiceEndpointAddress.IsNull())
            {
                ...
                _norsServiceEndpointAddress = new EndpointAddress(webAddress);
            }

            return _norsServiceEndpointAddress;
        }
        ...
        protected override String GetWebServiceAddress()
        {
            ...
            {
                WebServiceAddress = Settings.Default.NorsServiceAddress;
            }
        ...
        private class ClientProxy : IDisposable
        {
            ...
            /// The _web service.
            /// </summary>
            private readonly NorsServiceProxy _webService;
            ...
            public ClientProxy(NorsServiceProxy webService,
