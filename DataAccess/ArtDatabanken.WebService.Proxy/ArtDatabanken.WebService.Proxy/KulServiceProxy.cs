...
namespace ArtDatabanken.WebService.Proxy
{
    ...
    public class KulServiceProxy : WebServiceProxyBase
    {
        ...
        public override EndpointAddress GetEndpointAddress()
        {
            ...
            if (_kulServiceEndpointAddress.IsNull())
            {
                ...
                _kulServiceEndpointAddress = new EndpointAddress(webAddress);
            }

            return _kulServiceEndpointAddress;
        }
        ...
        protected override String GetWebServiceAddress()
        {
            ...
            {
                WebServiceAddress = Settings.Default.KulServiceAddress;
            }
        ...
        private class ClientProxy : IDisposable
        {
            ...
            /// The _web service.
            /// </summary>
            private readonly KulServiceProxy _webService;
            ...
            public ClientProxy(KulServiceProxy webService,
