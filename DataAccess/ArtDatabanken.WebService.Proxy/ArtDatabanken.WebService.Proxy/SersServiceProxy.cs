...
{
    /// <summary>
    /// Class that manages taxon service requests to Sers.
    /// </summary>
    public class SersServiceProxy : WebServiceProxyBase
    {
        /// <summary>
        /// The _sers service endpoint address.
        /// </summary>
        private EndpointAddress _sersServiceEndpointAddress;

        /// <summary>
        /// Create a SersServiceProxy instance.
        /// </summary>
        public SersServiceProxy()
        {
            WebServiceAddress = null;
            WebServiceProtocol = WebServiceProtocol.SOAP11;
            InternetProtocol = InternetProtocol.Http;
            _sersServiceEndpointAddress = null;
        }
        ...
        public override EndpointAddress GetEndpointAddress()
        {
            ...
            if (_sersServiceEndpointAddress.IsNull())
            {
               ...
               //// webAddress += @"/soap";
                ...
                _sersServiceEndpointAddress = new EndpointAddress(webAddress);
            }

            return _sersServiceEndpointAddress;
        }
        ...
        protected override String GetWebServiceAddress()
        {
            ...
            {
                WebServiceAddress = Settings.Default.SersServiceAddress;
            }
        ...
        private class ClientProxy : IDisposable
        {
            ...
            /// The _web service.
            /// </summary>
            private readonly SersServiceProxy _webService;
