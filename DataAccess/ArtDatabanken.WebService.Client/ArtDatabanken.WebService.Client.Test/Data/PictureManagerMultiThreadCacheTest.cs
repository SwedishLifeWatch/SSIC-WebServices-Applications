...
{
    [TestClass]
    public class PictureManagerMultiThreadCacheTest : TestBase
    {
        private PictureManagerMultiThreadCache _pictureManager;

        public PictureManagerMultiThreadCacheTest()
        {
        ...
        private PictureManager GetPictureManager(Boolean refresh = false)
        {
            ...
            {
                _pictureManager = new PictureManagerMultiThreadCache();
