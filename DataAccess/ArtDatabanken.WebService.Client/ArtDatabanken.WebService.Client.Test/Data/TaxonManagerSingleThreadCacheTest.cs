...
{
    [TestClass]
    public class TaxonManagerSingleThreadCacheTest : TestBase
    {
        private TaxonManagerSingleThreadCache _taxonManager;

        public TaxonManagerSingleThreadCacheTest()
        {
            _taxonManager = null;
        }
        ...
        private TaxonManagerSingleThreadCache GetTaxonManager(Boolean refresh = false)
        {
            if (_taxonManager.IsNull() || refresh)
            {
                _taxonManager = new TaxonManagerSingleThreadCache();
