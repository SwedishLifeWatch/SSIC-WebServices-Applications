...
{
    [TestClass]
    public class SpeciesObservationManagerSingleThreadCacheTest : TestBase
    {
        private SpeciesObservationManagerSingleThreadCache _speciesObservationManager;

        public SpeciesObservationManagerSingleThreadCacheTest()
        {
        ...
        private SpeciesObservationManagerSingleThreadCache GetSpeciesObservationManager(Boolean refresh = false)
       {
           if (_speciesObservationManager.IsNull() || refresh)
           {
               _speciesObservationManager = new SpeciesObservationManagerSingleThreadCache();
