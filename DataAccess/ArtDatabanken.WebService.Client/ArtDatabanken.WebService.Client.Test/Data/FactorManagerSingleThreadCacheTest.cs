...
{
    [TestClass]
    public class FactorManagerSingleThreadCacheTest : TestBase
    {
        private FactorManagerSingleThreadCache _factorManager;

        public FactorManagerSingleThreadCacheTest()
        {
            _factorManager = null;
        }
        ...
        public void GetFactorTree()
        {
            ...
            int factorId = 652; // Rödlistning enligt IUCN.
        ...
        private FactorManagerSingleThreadCache GetFactorManager(bool refresh = false)
        {
            if (_factorManager.IsNull() || refresh)
            {
                _factorManager = new FactorManagerSingleThreadCache();
