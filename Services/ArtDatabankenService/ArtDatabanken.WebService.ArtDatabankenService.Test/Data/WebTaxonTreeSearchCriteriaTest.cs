...
{
    [TestClass]
    public class WebTaxonTreeSearchCriteriaTest : TestBase
    {
        private WebTaxonTreeSearchCriteria _searchCriteria;
        ...
        private WebTaxonTreeSearchCriteria GetSearchCriteria()
        {
