...
using WebSpeciesObservationChange = ArtDatabanken.WebService.Proxy.NorsService.WebSpeciesObservationChange;
using WebSpeciesObservationField = ArtDatabanken.WebService.Proxy.NorsService.WebSpeciesObservationField;

namespace ArtDatabanken.WebService.SpeciesObservationHarvestService.DataProvider.Nors
{
    /// <summary>
    /// The nors connector.
    /// </summary>
    public class NorsConnector : IDataProviderConnector
    {
        /// <summary>
        ...
        {
            return new Data.SpeciesObservationManager().GetSpeciesObservationDataProvider(context, SpeciesObservationDataProviderId.Nors);
        }
    }
}
