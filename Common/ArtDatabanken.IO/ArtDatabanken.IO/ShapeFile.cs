...
namespace ArtDatabanken.IO
{
    ...
    public class ShapeFile
    {
        ...
        public void ReadAttributes(string dbaseFile)
        {
            ...
            // todo - In AnalysisPortal we use a specific ShapeFile.cs that uses Microsoft.ACE.OLEDB.12.0. Can that dll be used on every server?
            string connectionString = "PROVIDER=Microsoft.Jet.OLEDB.4.0;Data Source=" + directory + ";Extended Properties=dBASE 5.0";
            //string connectionString = "PROVIDER=Microsoft.ACE.OLEDB.12.0;Data Source=" + directory + ";Extended Properties=dBASE 5.0";
