...
<% Html.EnableClientValidation(); %> 
    <% using (Html.BeginForm("EditHostFactorItem", "SpeciesFact", FormMethod.Post, new { @id = "editHostFactorItemForm", @name = "editHostFactorItemForm" }))
    { %>    
...
<div id="fullContainer">
    ...
    <input type="hidden"id ="oldIndividualCategoryId" value="<%:Model.OldIndividualCategoryId%> ">
