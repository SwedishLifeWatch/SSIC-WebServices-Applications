...
<% Html.EnableClientValidation(); %> 
    <% using (Html.BeginForm("EditHostFactorItems", "SpeciesFact", FormMethod.Post, new { @id = "editHostFactorItemsForm", @name = "editHostFactorItemsForm" }))
    { %>    
...
<div id="fullContainer">
    ...
    <%: Html.HiddenFor(model => model.MainParentFactorId) %>   
     <%: Html.HiddenFor(model => model.OldIndividualCategoryId) %>   
        <fieldset>
            <h2 class="open"><%: Model.FactorName %></h2>
             <div class="fieldsetContent">
                 <br/>
                   <div class="formRow">
                        <div class="group">
                              <label><%: Model.HostTaxaHeader %></label>
                            <%: Html.TextAreaFor(model => model.HostTaxaText, new { @readonly="true" })%>
                 ...
                 <div class="formRow">
                        <div class="group">
                            ...
                            <%: Html.DisplayTextFor(model => model.IndividualCategoryName)%>
                          <%--  <%:Html.DropDownListFor(model => model.IndividualCategoryId, new SelectList(Model.IndividualCategoryList, "Id", "Text", Model.IndividualCategoryId),new {style="width: 300px;"})%>--%>
                        </div>
                    </div> 
               <%--  <div class="formRow">
