...
namespace ArtDatabanken.WebApplication.AnalysisPortal.IO
{
    ...
    /// </summary>
    public class ObservedTaxonCountListAsExcelXlsx : ExcelXlsxBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ObservedTaxonCountListAsExcelXlsx"/> class.
        /// </summary>
        ...
        public ObservedTaxonCountListAsExcelXlsx(IUserContext currentUser, bool addSettings, bool addProvenance)
        {
        ...
        private void AddHeaders(ExcelWorksheet worksheet)
        {
            ...
            worksheet.Cells[1, 8].Value = Resource.LabelSpeciesObservationCount;
        }

        private void AddContentData(ExcelWorksheet worksheet, IEnumerable<TaxonSpeciesObservationCountViewModel> data)
        {
            var rowIndex = 2;
            ...
            foreach (var row in data)
            {
                ...
                worksheet.Cells[rowIndex, 8].Value = row.SpeciesObservationCount;
