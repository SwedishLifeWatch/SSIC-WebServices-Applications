...
namespace ArtDatabanken.WebApplication.AnalysisPortal.Test.TestModels
{
    public class UserDataSourceTestRepository:IUserDataSource
    {
        ...
        public IUserContext Login(string userName, string password, string applicationIdentifier, bool isActivationRequired)
        {
            ...
            userContext.CurrentRoles.Add(GetNewRole(userContext.User.UserName,0));
            return userContext;
        }
        ...
        private IUser GetNewUser()
        {
            ...
            newUser.ValidToDate = newUser.ValidFromDate + new TimeSpan(ArtDatabanken.Data.Settings.Default.ValidToDateYearIncrement * 365, 0, 0, 0);
            return newUser;
        }
