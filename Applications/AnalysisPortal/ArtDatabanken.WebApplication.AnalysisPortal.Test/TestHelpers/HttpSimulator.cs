...
namespace ArtDatabanken.WebApplication.AnalysisPortal.Test.TestHelpers
{
    ...
    {
        private const string defaultPhysicalAppPath = @"c:\InetPub\wwwRoot\AnalysisPortalTestRun";
        ...
        public HttpSimulator(string physicalApplicationPath)
            : this(physicalApplicationPath, "/")
        {

        }

        public HttpSimulator(string physicalApplicationPath, string applicationPath)
        {
